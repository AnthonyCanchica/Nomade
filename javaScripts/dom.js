...
<div class="contenedor-info">
	<!-- Direccion -->
	<div id="direccion">
	<img src="../imagenesDos/logos/alfiler.png" class="logoutm" alt="telefono">
		<h3>DIRECCIÓN</h3>
	...
	<!-- Numeros -->
	<div id="telefono">
		<img src="../imagenesDos/logos/informacion.png" class="logoutm" alt="telefono">
		<h3>TELÉFONO</h3>
	...
	<!-- Emails -->
	<div id="email">
		<img src="../imagenesDos/logos/correo-electronico.png" class="logoutm" alt="telefono">
		<h3>Email</h3>
